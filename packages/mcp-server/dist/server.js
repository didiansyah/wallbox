...
export function createWallboxMcpServer() {
    ...
    server.registerTool("wallbox_capture_run", {
    ...
    server.registerTool("wallbox_verify_certificate", {
    ...
    server.registerTool("wallbox_get_run", {
    ...
    server.registerTool("wallbox_list_runs", {
    ...
    server.registerTool("wallbox_status", {
